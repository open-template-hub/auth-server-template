...
export class TeamController {
  ...
  addWriter = async (
    ...
    const joinTeamToken = this.tokenUtil.generateJoinTeamToken( writerUser.username, {
      id: team.team_id,
  ...
  addReader = async (
    ...
    const joinTeamToken = this.tokenUtil.generateJoinTeamToken( readerUser.username, {
      id: team.team_id,
